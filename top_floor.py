    ...
    while do_input == "look around":
        ...
        if room_input == "B":
            ...
            if office_input.lower() == "c":
                ...
                while (rps_input.lower() == 'rock' and computer_choice == 'paper') or (rps_input == 'paper' and computer_choice == 'scissors') or (rps_input == 'scissors' and computer_choice == 'rock') or (rps_input == computer_choice) or (rps_input not in rps_list):
